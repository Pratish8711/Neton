...
gift = ["Pen" , "Perfum" , "Teddy Bear" , " Photo Frame" , "Cake" , "Flower Bouquets" , "A Custom Wallet" , "Watch Box"]
error = True
...
while error :
    ...
    if level.lower() == "easy" or level == "1" :
        ...
        while chance :
            ...
            if guess ==  ran :
                ...
                ran_gift = random.choice(gift)

                print ("Congrats You Won" ,ran_gift ,".....................")
    ...
    print ("""              THANK YOU  FOR PLAYING THIS AWESOME GAME WITH US !! HOPE TO SEE YOU AGAIN    """)
